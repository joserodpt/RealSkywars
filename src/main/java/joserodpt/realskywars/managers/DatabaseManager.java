...
public class DatabaseManager {
    ...
    private @NotNull String getDatabaseURL() {
        final String driver = RSWSQLConfig.file().getString("driver").toLowerCase(Locale.ROOT);
        ...
        switch (driver) {
            ...
            default:
                return "jdbc:sqlite:" + new File(javaPlugin.getDataFolder(), RSWSQLConfig.file().getString("database") + ".db");
        }
    }
