        ...
        try {
            switch (ts) {
                ...
                case MAP_EXISTS:
                    ...
                    break;
                case KIT_EXISTS:
                    tr = Text.color(Languages.file().getString("Languages." + lang + ".Messages.Commands.Kit-Exists"));
                    break;
                ...
                case ARENA_REGISTERED:
                    ...
                    break;
                case VOTE:
                    tr = Text.color(Languages.file().getString("Languages." + lang + ".Messages.Vote.Vote"));
                    break;
                case ALREADY_VOTED:
                    tr = Text.color(Languages.file().getString("Languages." + lang + ".Messages.Vote.Already-Voted"));
                    break;
                ...
                case ITEM_CHEST2_NAME:
                    ...
                    break;
                case ITEM_VOTE_NAME:
                    tr = Text.color(Languages.file().getString("Languages." + lang + ".Itens.Vote.Name"));
                    break;
                ...
                case MENU_SPECTATOR_SHOP_TITLE:
                    tr = Text.color(Languages.file().getString("Languages." + lang + ".Menus.Spectator-Shop-Menu-Title"));
                    break;
                case CANT_JOIN:
                ...
                case ACHIEVEMENTS:
                    ...
                    break;
                case TIME_DAY:
                    tr = Text.color(Languages.file().getString("Languages." + lang + ".Messages.Vote.Time.Day"));
                    break;
                case TIME_NIGHT:
                    tr = Text.color(Languages.file().getString("Languages." + lang + ".Messages.Vote.Time.Night"));
                    break;
                case TIME_RAIN:
                    tr = Text.color(Languages.file().getString("Languages." + lang + ".Messages.Vote.Time.Rain"));
                    break;
                case TIME_SUNSET:
                    tr = Text.color(Languages.file().getString("Languages." + lang + ".Messages.Vote.Time.Sunset"));
                    break;
                case PROJECTILE_BREAK:
                    tr = Text.color(Languages.file().getString("Languages." + lang + ".Messages.Vote.Projectiles.Break"));
                    break;
                case PROJECTILE_NORMAL:
                    tr = Text.color(Languages.file().getString("Languages." + lang + ".Messages.Vote.Projectiles.Normal"));
                    break;
                case MENU_PLAYERP_GAME_HISTORY:
                    tr = Text.color(Languages.file().getString("Languages." + lang + ".Menus.Game-History-Title"));
                    break;
                default:
