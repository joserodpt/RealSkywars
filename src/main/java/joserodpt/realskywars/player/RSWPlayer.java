...
public class RSWPlayer {
    ...
    public void saveData(PlayerData pd) {
        if (pd == PlayerData.GAME) {
            ...
            RealSkywars.getPlugin().getCurrencyAdapter().addCoins(this, this.balanceGame);
            this.balanceGame = 0D;
            this.gamekills = 0;
        }
    ...
    public double getGameBalance() { return RealSkywars.getPlugin().getCurrencyAdapter().getCoins(this) + this.balanceGame; }
    ...
    public SWGame getMatch() {
        return this.room;
    }

    public void setRoom(SWGame o) {
        this.room = o;
    }
    ...
    public class PlayerScoreboard {
        ...
        private String nextEvent(SWGame match) {
