...
public class GUIManager {
    ...
    public static void openChestVote(RSWPlayer p) {
        GUIBuilder inventory = new GUIBuilder(RealSkywars.getPlugin().getLanguageManager().getString(p, LanguageManager.TS.MENU_CHESTS_TITLE, false), 27, p.getUUID(), Itens.createItem(Material.BLACK_STAINED_GLASS_PANE, 1, ""));
        ...
        }, Itens.createItemLore(Material.WOODEN_SWORD, 1, RealSkywars.getPlugin().getLanguageManager().getString(p, LanguageManager.TS.CHEST_BASIC, false), Collections.emptyList()), 10);
        ...
        }, Itens.createItemLore(Material.CHEST, 1, RealSkywars.getPlugin().getLanguageManager().getString(p, LanguageManager.TS.CHEST_NORMAL, false), Collections.emptyList()), 13);
        ...
        }, Itens.createItemLore(Material.ENDER_CHEST, 1, RealSkywars.getPlugin().getLanguageManager().getString(p, LanguageManager.TS.CHEST_EPIC, false), Collections.emptyList()), 16);
    ...
    public static void openTimeVote(RSWPlayer p) {
        GUIBuilder inventory = new GUIBuilder(RealSkywars.getPlugin().getLanguageManager().getString(p, LanguageManager.TS.MENU_TIME_TITLE, false), 27, p.getUUID(), Itens.createItem(Material.BLACK_STAINED_GLASS_PANE, 1, ""));
        ...
        }, Itens.createItemLore(Material.YELLOW_CONCRETE, 1, RealSkywars.getPlugin().getLanguageManager().getString(p, LanguageManager.TS.TIME_DAY, false), Collections.emptyList()), 10);
        ...
        }, Itens.createItemLore(Material.RED_CONCRETE, 1, RealSkywars.getPlugin().getLanguageManager().getString(p, LanguageManager.TS.TIME_SUNSET, false), Collections.emptyList()), 13);
        ...
        }, Itens.createItemLore(Material.BLACK_CONCRETE, 1, RealSkywars.getPlugin().getLanguageManager().getString(p, LanguageManager.TS.TIME_NIGHT, false), Collections.emptyList()), 16);
    ...
    public static void openProjectileVote(RSWPlayer p) {
        GUIBuilder inventory = new GUIBuilder(RealSkywars.getPlugin().getLanguageManager().getString(p, LanguageManager.TS.MENU_PROJECTILES_TITLE, false), 27, p.getUUID(), Itens.createItem(Material.BLACK_STAINED_GLASS_PANE, 1, ""));
        ...
        }, Itens.createItemLore(Material.EGG, 1, RealSkywars.getPlugin().getLanguageManager().getString(p, LanguageManager.TS.PROJECTILE_NORMAL, false), Collections.emptyList()), 12);
        ...
        }, Itens.createItemLore(Material.COBBLESTONE, 1, RealSkywars.getPlugin().getLanguageManager().getString(p, LanguageManager.TS.PROJECTILE_BREAK, false), Collections.emptyList()), 14);
    ...
    public static void openVote(RSWPlayer p) {
        GUIBuilder inventory = new GUIBuilder(RealSkywars.getPlugin().getLanguageManager().getString(p, LanguageManager.TS.MENU_VOTE_TITLE, false), 27, p.getUUID(), Itens.createItem(Material.BLACK_STAINED_GLASS_PANE, 1, ""));

        inventory.addItem(e -> {
            p.closeInventory();
            openChestVote(p);
        }, Itens.createItemLore(Material.CHEST, 1, RealSkywars.getPlugin().getLanguageManager().getString(p, LanguageManager.TS.MENU_CHESTS_TITLE, false), Collections.emptyList()), 10);

        inventory.addItem(e -> {
            p.closeInventory();
            openProjectileVote(p);
        }, Itens.createItemLore(Material.ARROW, 1, RealSkywars.getPlugin().getLanguageManager().getString(p, LanguageManager.TS.MENU_PROJECTILES_TITLE, false), Collections.emptyList()), 13);

        inventory.addItem(e -> {
            p.closeInventory();
            openTimeVote(p);
        }, Itens.createItemLore(Material.CLOCK, 1, RealSkywars.getPlugin().getLanguageManager().getString(p, LanguageManager.TS.MENU_TIME_TITLE, false), Collections.emptyList()), 16);
