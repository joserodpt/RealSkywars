...
public class RSWPlayerSB {
    ...
    protected String variables(String s, RSWPlayer p) {
        ...
        if (p.isInMatch()) {
            tmp = s.replace("%space%", Text.makeSpace()).replace("%players%", p.getMatch().getPlayerCount() + "").replace("%maxplayers%", p.getMatch().getMaxPlayers() + "").replace("%time%", p.getMatch().getTimePassed() + "").replace("%nextevent%", nextEvent(p.getMatch())).replace("%spectators%", p.getMatch().getSpectatorsCount() + "").replace("%kills%", p.getStatistics(RSWPlayer.PlayerStatistics.GAME_KILLS) + "").replace("%map%", p.getMatch().getMapName()).replace("%displayname%", p.getMatch().getDisplayName()).replace("%runtime%", Text.formatSeconds(p.getMatch().getTimePassed())).replace("%state%", p.getMatch().getState().getDisplayName(p)).replace("%mode%", p.getMatch().getGameMode().getDisplayName(p)).replace("%solowins%", p.getStatistics(RSWPlayer.PlayerStatistics.WINS_SOLO) + "").replace("%teamwins%", p.getStatistics(RSWPlayer.PlayerStatistics.WINS_TEAMS) + "").replace("%loses%", p.getStatistics(RSWPlayer.PlayerStatistics.LOSES) + "").replace("%gamesplayed%", p.getStatistics(RSWPlayer.PlayerStatistics.GAMES_PLAYED) + "");
        } else {
            tmp = s.replace("%space%", Text.makeSpace()).replace("%coins%", RealSkywarsAPI.getInstance().getCurrencyAdapter().getCoins(p) + "").replace("%playing%", "" + RealSkywarsAPI.getInstance().getPlayerManagerAPI().getPlayingPlayers(MapManagerAPI.MapGamemodes.ALL)).replace("%kills%", p.getStatistics(RSWPlayer.PlayerStatistics.KILLS, false) + "").replace("%deaths%", p.getStatistics(RSWPlayer.PlayerStatistics.DEATHS, false) + "").replace("%solowins%", p.getStatistics(RSWPlayer.PlayerStatistics.WINS_SOLO, false) + "").replace("%teamwins%", p.getStatistics(RSWPlayer.PlayerStatistics.WINS_TEAMS, false) + "").replace("%loses%", p.getStatistics(RSWPlayer.PlayerStatistics.LOSES, false) + "").replace("%gamesplayed%", p.getStatistics(RSWPlayer.PlayerStatistics.GAMES_PLAYED) + "").replace("%playing%", "" + RealSkywarsAPI.getInstance().getPlayerManagerAPI().getPlayingPlayers(MapManagerAPI.MapGamemodes.ALL)).replace("%rankedkills%", p.getStatistics(RSWPlayer.PlayerStatistics.KILLS, true) + "").replace("%rankeddeaths%", p.getStatistics(RSWPlayer.PlayerStatistics.DEATHS, true) + "").replace("%rankedsolowins%", p.getStatistics(RSWPlayer.PlayerStatistics.WINS_SOLO, true) + "").replace("%rankedteamwins%", p.getStatistics(RSWPlayer.PlayerStatistics.WINS_TEAMS, true) + "").replace("%rankedloses%", p.getStatistics(RSWPlayer.PlayerStatistics.LOSES, true) + "").replace("%rankedgamesplayed%", p.getStatistics(RSWPlayer.PlayerStatistics.GAMES_PLAYED, true) + "");
        }
